<div>
    <div>
        ...
        <!-- ========== FOOTER ========== -->
        <footer class="mt-auto bg-cyan-900 w-full dark:bg-neutral-950">
            <div class="max-w-[85rem] mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            <!-- Grid -->
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                @if($menu && $menu->menuItems)
                    @foreach($menu->menuItems as $item) 
                        ...
                        <h4 class="font-semibold text-gray-100">{{ $item->title }}</h4>
                        
                        @foreach($item->children as $child)
                        <div class="mt-3 grid space-y-3">
                            <p>
                                <a wire:navigate href="{{ $child->url }}" class="inline-flex gap-x-2 text-gray-100 hover:text-gray-300 focus:outline-none focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200">
                                    {{ $child->title }}
                                </a>
                            </p>
                        </div>
                ...
                <form>
                    ...
                    <a class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-sky-900 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
                        Subscribe
                    </a>
                    </div>
