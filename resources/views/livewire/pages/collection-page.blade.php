...
<div class="w-full max-w-[85rem] py-6 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="py-6 border border-gray-300 bg-gray-50 dark:bg-gray-800 rounded-lg">
        <div class="max-w-7xl mx-auto px-4 lg:py-2 md:px-6">
            ...
            <!-- Collection Title -->
            <h2 class="text-2xl font-bold px-1 mb-6">
                {{ $collection->name }}
            </h2>
            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                ...
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    <div class="px-4 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                        <h2 class="text-md font-semibold text-white dark:text-gray-400 bg-[#003953] rounded p-2 mb-2">{{ __('All Collections') }}</h2>                

                        <ul class="space-y-0">
                            @forelse ($collections as $collection)
                                <li>
                                    <a wire:navigate href="{{ route('collections.show', $collection->slug) }}" 
